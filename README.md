...
The development branch also has the durable browser-action service and encrypted
adapter; its trusted review UI is still being connected. Shared viewers remain
read-only.
