...
- The development branch also adds [Change this app](docs/app-changes.md): an exact installed-byte working copy, History, and a Chat draft, with predecessor checks on reviewed preview updates. Direct target-update navigation and source-Space preview placement remain in progress.
