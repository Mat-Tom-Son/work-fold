...
small request fails, the Chat remains **New Chat** rather than presenting its
...
10. **Root authority and secrets are setup surfaces:** Remote access administration, pairing machinery, provider credentials, standing-policy authoring, and the Reviewed/Unrestricted selector are local desktop Settings acts with no Assistant, CLI, or remote verb.
