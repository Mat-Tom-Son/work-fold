...
tabs, restarts, and machines. If the small title request fails, work-fold falls
back to a bounded title derived from the first request; naming can never fail an
otherwise successful turn. An explicit
