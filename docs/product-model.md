...
- Queue one follow-up message behind a running Assistant turn as a visible, cancellable draft that sends when the turn settles; Stop returns it to the composer instead of firing it into the stopped turn's aftermath.
