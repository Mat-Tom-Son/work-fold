...
work-fold 0.3.15 makes Space management quieter and more direct, and closes
...
- Clean lockfile installation, high-severity dependency audit, desktop
...
- Developer ID signing, Apple notarization and stapling, Gatekeeper, updater
  metadata, checksums, and public-asset verification for tag `v0.3.15`.
