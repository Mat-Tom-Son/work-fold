...
Candidate 0.4.18 was not tagged or published: its CI desktop smoke encountered
a restricted-app document-load timeout. Local desktop preparation and repeated
real-Electron probes passed without changing timeout or safety assertions.
The smoke now emits phase diagnostics to CI logs. Publication requires fresh
successful main and source-tag CI for this higher candidate.
