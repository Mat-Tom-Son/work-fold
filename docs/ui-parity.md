...
- Settings uses Appearance, Agents, General, Desktop, and About. General carries Web access, Shared pages, Automations, Recently deleted (the entry list, Restore, Save a copy, Delete now, and the retention window), and Limits; no authority selector or standing-rules section exists on any surface.
