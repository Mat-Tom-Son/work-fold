...
- A conditional **Needs you** indicator may join the bottom-rail cluster only while an Assistant question or a due snooze waits, opening an anchored flyout of those items; the glance opens as a compact panel from the Space-identity header region. Neither is a rail destination, tab, permanent badge, or notification stream, and both disappear entirely when they have nothing to show.
