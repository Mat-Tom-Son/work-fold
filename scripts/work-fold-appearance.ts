...
async function inspectCommand(command: "validate" | "resolve", args: string[]): Promise<void> {
  ...
  process.stdout.write(`Valid work-fold appearance proposal: ${path}\n`);
  printAudit(proposal);
}
...
function printHelp(): void {
  process.stdout.write(`work-fold appearance proposal tool
...
Commands:
  ...
  validate <proposal.work-fold-appearance.json> [--json]
  resolve  <proposal.work-fold-appearance.json> [--json]
